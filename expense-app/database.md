...
### Create EC2 instance in aws and copy the public IP address login to the server using MobaXterm rename as database server

**Need root user to install the mysql server**
...
```
## Troubleshooting steps for database server

To check the current operation state, health and log activity of mysql server
**Service Status**
```
